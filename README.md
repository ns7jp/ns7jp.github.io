...
公共職業訓練（2025年10月〜2026年1月）で学んだ HTML / CSS / JavaScript / Python / PHP の成果をまとめたポートフォリオサイトです。制作した Web アプリ、デスクトップアプリ、サーバー監視ツールを一覧できるようにし、各作品の概要・使用技術・学習ポイント・デモリンク・GitHub リンクへアクセスできる構成にしています。
...
このサイトは、単に作品リンクを並べるだけではなく、**未経験から IT エンジニアを目指す過程で、どの技術を学び、どのような考え方で作品を作ったかを伝えるためのサイト**です。
...
| ⑥ | サーバー監視ダッシュボード | Python / Flask / psutil / Chart.js | PCやサーバーの状態をブラウザで可視化する監視ツール | [ns7jp/server-monitor](https://github.com/ns7jp/server-monitor) |
